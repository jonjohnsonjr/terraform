...
func (n *nodeExpandLocal) DynamicExpand(ctx context.Context, ectx EvalContext) (*Graph, error) {
	// ctx, span := otel.Tracer("github.com/hashicorp/terraform").Start(ctx, "nodeExpandLocal.DynamicExpand")
	// defer span.End()
...
// the state.
func (n *NodeLocal) Execute(_ context.Context, ectx EvalContext, op walkOperation) (diags tfdiags.Diagnostics) {
	expr := n.Config.Expr
