...
// GraphNodeExecutable
func (n *nodeExpandModule) Execute(_ context.Context, ectx EvalContext, op walkOperation) (diags tfdiags.Diagnostics) {
...
func (n *nodeCloseModule) Execute(_ context.Context, ectx EvalContext, op walkOperation) (diags tfdiags.Diagnostics) {
	if !n.Addr.IsRoot() {
		return
	}
...
// GraphNodeEvalable
func (n *nodeValidateModule) Execute(_ context.Context, ectx EvalContext, op walkOperation) (diags tfdiags.Diagnostics) {
	_, call := n.Addr.Call()
	expander := ectx.InstanceExpander()
