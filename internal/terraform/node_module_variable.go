...
func (n *nodeExpandModuleVariable) DynamicExpand(ctx context.Context, ectx EvalContext) (*Graph, error) {
	// ctx, span := otel.Tracer("github.com/hashicorp/terraform").Start(ctx, "nodeExpandModuleVariable.DynamicExpand")
	// defer span.End()
